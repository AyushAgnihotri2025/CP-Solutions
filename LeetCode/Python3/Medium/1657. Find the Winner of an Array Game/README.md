<h2><a href="https://leetcode.com/problems/find-the-winner-of-an-array-game">1535. Find the Winner of an Array Game</a></h2><hr><p>Given an integer array <code>arr</code> of <strong>distinct</strong> integers and an integer <code>k</code>.</p>
