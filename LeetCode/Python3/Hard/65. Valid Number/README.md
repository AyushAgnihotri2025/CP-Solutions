<h2><a href="https://leetcode.com/problems/valid-number/">65. Valid Number</a></h2><hr><p>A <strong>valid number</strong> can be split up into these components (in order):</p>
