<h2><a href="https://leetcode.com/problems/shortest-path-to-get-all-keys/">864. Shortest Path to Get All Keys</a></h2><hr><p>You are given an <code>m x n</code> grid <code>grid</code> where:</p>
