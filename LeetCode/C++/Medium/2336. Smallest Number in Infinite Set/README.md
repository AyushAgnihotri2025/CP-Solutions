<h2><a href="https://leetcode.com/problems/smallest-number-in-infinite-set/">2336. Smallest Number in Infinite Set</a></h2><hr><p>You have a set which contains all positive integers <code>[1, 2, 3, 4, 5, ...]</code>.</p>
